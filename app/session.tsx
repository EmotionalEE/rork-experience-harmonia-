...
import { SynchroGeometry, SacredGeometry, UnwindGeometry, QuietAlarmGeometry } from "@/components/SessionGeometry";
...
export default function SessionScreen() {
  ...
  const isUnwindSession = session?.id === 'stress-release-flow';
